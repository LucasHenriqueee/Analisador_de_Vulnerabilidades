...
# Função para criar um oráculo
def create_oraculo(pc_number, switch_x, switch_y):
    oraculo_id = str(uuid.uuid4())

    #variavél "PC" que contem a descricao dos cogidos JSON
    pc = {
        "compute_id": "local",
        ...
        "properties": {
            "adapters": 1,
            "aux": pc_port + pc_number + 1,
            "console_http_path": "/",
            "console_http_port": 80,
            "console_resolution": "1024x768",
            "container_id": "98633ba2708356737154532f20edf406fe8388d785d4c5a04637513b401bf207", ## ALTERAR VALOR DESSA VARIAVEL PARA SER GERAR AQUI COM uuid4
            "environment": "null",
            "extra_hosts": "null",
            "extra_volumes": [],
        ...
        "template_id": "7f6da3e9-0dba-423b-82e4-18014b5f2922", ## ALTERAR VALOR DESSA VARIAVEL PARA SER GERAR AQUI COM uuid4
        "width": 65,
        "x": -206,
        "y": -106,
        "z": 1
